...
<body class="cbp-spmenu-push">
    <div class="main-content">
        ...
        <div id="page-wrapper">
            <div class="main-page">
                <div class="tables">
                    <h2 class="title1">Staff Master</h2>
                    <div class="bs-example widget-shadow" data-example-id="hoverable-table">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT staff_master.Staff_Id, Staff_College_Id, First_Name, Middle_Name, Last_Name, Branch_Name, Designation_Name, Contact_No, Staff_Status FROM staff_master JOIN staff_branch ON staff_branch.Staff_Id = staff_master.Staff_Id JOIN branch_master ON staff_branch.Branch_Id = branch_master.Branch_Id JOIN designation_master ON staff_branch.Designation_Id = designation_master.Designation_Id";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<tr scope='row'>";
                                    echo "<th>" . $count . "</th>";
                                    echo "<td>" . $row['Staff_College_Id'] . "</td>";
                                    ...
                                    if ($StaffStatus == "Active") {
                                        echo "<td><span class='label label-success'>" . $StaffStatus . "</span></td>";
                                    } else {
                                        echo "<td><span class='label label-danger'>" . $StaffStatus . "</span></td>";
                                    }

                                    echo "<td><button type='button' class='btn btn-success' onclick='edit(" . $row['Staff_Id'] . ")'>Edit</button></td>";
                                    echo "</tr>";
