                            ...
                            <div class="form-body">
                                <form class="form-horizontal" action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="txt_DateOfBirth" name="txt_DateOfBirth" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="txt_Contact" name="txt_Contact" placeholder="Contact" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="txt_Email" class="col-sm-2 control-label">Email ID</label>
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" id="txt_Email" name="txt_Email" placeholder="Email ID" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="txt_Address" class="col-sm-2 control-label">Address</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="txt_Address" name="txt_Address" placeholder="Address" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="select_BranchId" class="col-sm-2 control-label">Branch</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="select_DesignationId" class="col-sm-2 control-label">Designation</label>
                                        <div class="col-sm-9">
                                            <select id="select_DesignationId" name="select_DesignationId" class="form-control">
                                                <?php

                                                $sql = "SELECT * FROM designation_master WHERE designation_status = \"Active\"";
                                                $result = $con->query($sql);
                                                while ($row = $result->fetch_array()) {
                                    ...
                                    <div class="form-group class12-form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="txt_CollegeId" name="txt_CollegeId" placeholder="College ID" required>
                                        </div>
                                    </div>
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    $DesignationId = $_POST['select_DesignationId'];
                                    $StaffStatus = "Active";

                                    $sql1 = "INSERT INTO staff_master(Staff_College_Id, First_Name, Middle_Name, Last_Name, Date_Of_Birth, Gender, Contact_No, Email_Id, Address, Staff_Status) VALUES('" . $CollegeId . "', '" . $FirstName . "','" . $MiddleName . "','" . $LastName . "','" . $DateOfBirth . "','" . $Gender . "','" . $ContactNo . "','" . $EmailId . "','" . $Address . "','" . $StaffStatus . "')";
                                    ...
                                    if ($con->query($sql1) === TRUE) {
                                        ...
                                        $sql3 = "INSERT INTO staff_branch(Staff_Id, Branch_Id, Designation_Id, Staff_Branch_Status) VALUES(" . $StaffId . ", " . $BranchId . ", " . $DesignationId . ", '" . $StaffBranchStatus . "')";

                                        if ($con->query($sql3) === TRUE) {

                                            $StaffLoginStatus = "Active";
                                            $sql4 = "INSERT INTO staff_login(Staff_Id, Staff_Username, Staff_Password, Staff_Login_Status) VALUES(" . $StaffId . ", 'T" . $CollegeId . "', 'T" . $CollegeId . "', '" . $StaffLoginStatus . "')";
