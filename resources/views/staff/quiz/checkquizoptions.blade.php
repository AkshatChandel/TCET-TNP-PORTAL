                    ...
                    <div class="col-md-12 panel-grids">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                $studentQuizAnswer = App\Models\Student_Quiz_Answer::where('Student_Quiz_Id', '=', $StudentQuizId)
                                    ->where('Quiz_Question_Id', '=', $quizQuestionsOptions[$i]->Quiz_Question_Id)
                                    ->first();

                                $answerMarkedByStudent = $studentQuizAnswer->Quiz_Question_Option_Id;
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        @elseif(($quizQuestionsOptions[$i + $j]->Is_Correct_Answer != "Yes") && ($quizQuestionsOptions[$i + $j]->Quiz_Question_Option_Id == $answerMarkedByStudent))
                                        <label class="form-control1" style="background-color: red">{{ $quizQuestionsOptions[$i + $j]->Quiz_Option }}</label>
                                        @else
