...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2022 at 12:04 AM
...
--
ALTER TABLE `training_lecture`
  MODIFY `Training_Lecture_Id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `training_lecture_branch`
  MODIFY `Training_Lecture_Branch_Id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
