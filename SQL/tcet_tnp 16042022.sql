...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2022 at 11:09 PM
...
(1, 'Death Note', 'Death Note (stylized in all caps) is a Japanese manga series written by Tsugumi Ohba and illustrated by Takeshi Obata. The story follows Light Yagami, a teen genius who discovers a mysterious notebook: the \"Death Note\", which belonged to the Shinigami Ryuk, and grants the user the supernatural ability to kill anyone whose name is written in its pages. The series centers around Light\'s subsequent attempts to use the Death Note to carry out a worldwide massacre of individuals whom he deems immoral and to create a crime-free society, using the alias of a god-like vigilante named \"Kira\", and the subsequent efforts of an elite Japanese police task force, led by enigmatic detective L, to apprehend him.', 1, 'De-Active'),
(2, 'F.R.I.E.N.D.S', 'Friends is an American television sitcom created by David Crane and Marta Kauffman, which aired on NBC from September 22, 1994, to May 6, 2004, lasting ten seasons.[1] With an ensemble cast starring Jennifer Aniston, Courteney Cox, Lisa Kudrow, Matt LeBlanc, Matthew Perry and David Schwimmer, the show revolves around six friends in their 20s and 30s who live in Manhattan, New York City.', 3, 'Active'),
...
(25, 1, 'Class 10 Percentage - 75%'),
(26, 1, 'Class 12 Percentage - 60%'),
(27, 1, 'CGPA - 7');
...
(37, 1, 'Aptitude Test', '2022-04-06 12:00:00', 60, 'To be held'),
(38, 1, 'Coding Round 1', '2022-04-07 12:00:00', 90, 'To be held'),
(39, 1, 'Coding Round 2', '2022-04-08 14:00:00', 90, 'To be held'),
(40, 1, 'Technical Interview', '2022-04-10 15:00:00', 120, 'To be held'),
(41, 1, 'HR Interview', '2022-04-11 15:00:00', 120, 'To be held');
...
--
-- Dumping data for table `company_student_registration`
--

INSERT INTO `company_student_registration` (`Company_Student_Registration_Id`, `Company_Id`, `Student_Class_Id`, `Company_Student_Registration_Status`) VALUES
(1, 2, 1, 'Approved'),
(2, 6, 1, 'Approved');
...
(2, 3, 'T182084102', 'T182084102', 'No', 'Active');
...
(3, '182084102', 'Yogesh', 'H', 'Parekh', '1965-08-05', 'Male', '1234567890', 'test@example.com', 'Mumbai', 'Active');
...
(1, '182084101', 'Yash', 'Hitesh', 'Jobalia', '2003-01-02', 'Male', '9769264884', 'jobaliayash@gmail.com', 'Mira Road', 87.4, 'Class 12', 66, 0, 35, 360, 101, 200, 'Active'),
...
CREATE TABLE `training_lecture` (
  ...
  `Lecture_Description` varchar(2000) DEFAULT NULL,
  `Lecture_Code` varchar(50) DEFAULT NULL,
  `Lecture_DateTime` datetime NOT NULL,
  `Lecture_Link` varchar(1000) DEFAULT NULL,
  `Academic_Session_Id` bigint(20) NOT NULL,
  `Lecture_Status` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `training_lecture`
--

INSERT INTO `training_lecture` (`Training_Lecture_Id`, `Lecture_Name`, `Lecture_Description`, `Lecture_Code`, `Lecture_DateTime`, `Lecture_Link`, `Academic_Session_Id`, `Lecture_Status`) VALUES
(1, 'Lecture 1', NULL, '1', '2022-04-01 10:00:00', 'www.google.com', 1, 'To be conducted'),
(2, 'Lecture 2', 'Lecture 2 Description', '2', '2022-04-25 13:00:00', 'www.google.com', 1, 'To be conducted'),
(3, 'Lecture 3', 'Lecture 3 Description', '3', '2022-05-31 15:30:00', 'www.facebook.com', 3, 'To be conducted');
...
--
-- Dumping data for table `training_lecture_branch`
--

INSERT INTO `training_lecture_branch` (`Training_Lecture_Branch_Id`, `Training_Lecture_Id`, `Branch_Id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4),
...
--
ALTER TABLE `academic_session_master`
  MODIFY `Academic_Session_Id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `announcement_branch`
  MODIFY `Announcement_Branch_Id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `company_branch`
  MODIFY `Company_Branch_Id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `company_criteria`
--
ALTER TABLE `company_criteria`
  MODIFY `Company_Criteria_Id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `company_round`
  MODIFY `Company_Round_Id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `company_student_registration`
  MODIFY `Company_Student_Registration_Id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `student_quiz`
  MODIFY `Student_Quiz_Id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `student_quiz_answer`
--
ALTER TABLE `student_quiz_answer`
  MODIFY `Student_Quiz_Answer_Id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `training_lecture`
--
ALTER TABLE `training_lecture`
  MODIFY `Training_Lecture_Id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `training_lecture_branch`
  MODIFY `Training_Lecture_Branch_Id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
