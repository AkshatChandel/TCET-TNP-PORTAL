                            ...
                            <div class="form-body" action="" method="POST">
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="txt_SessionName" placeholder="Academic Session">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="select_SessionStatus" class="col-sm-2 control-label">Password</label>
                                        <div class="col-sm-9">
