...
class MessageController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view("staff.message.index", ["messageDrafts" => $data]);
    }

    public function create()
    {
        return view("staff.message.create");
    }
    ...
    public function send($MessageDraftId)
    {
        ...
        return view("staff.message.send_message", ["messageDraft" => $messageDraft[0], "academicSessions" => $academicSessions, "branches" => $branches]);
    }
    ...
    public function view($MessageDraftId)
    {
        ...
        return view("staff.message.view", ["messageDraft" => $messageDraft[0], "messageSentTo" => $messageSentTo]);
    }
}
