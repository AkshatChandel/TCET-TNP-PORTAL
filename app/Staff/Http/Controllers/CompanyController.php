...
class CompanyController extends Controller
{
    ...
    public function edit($CompanyId)
    {
        ...
        return view("staff.company.edit", ['company' => $companyDetails, 'companyBranches' => $companyBranches, 'companyCriterias' => $companyCriterias, 'companyRounds' => $companyRounds, 'branches' => $branches, 'AcademicSessions' => $AcademicSessions]);
    }
