...
class AnnouncementController extends Controller
{
    ...
    public function create()
    {
        ...
        return view("staff.announcement.create", ["branches" => $branches]);
        // return view("staff.announcement.create", ["branches" => $branches, "AcademicSessions" => $AcademicSessions]);
    }
    ...
    public function viewAnnouncementDetails($AnnouncementId)
    {
        ...
        return view("staff.announcement.view", ["announcement" => $announcement, "announcementBranches" => $announcementBranches]);
    }
}
