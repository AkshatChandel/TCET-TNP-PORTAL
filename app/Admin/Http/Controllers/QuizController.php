...
class QuizController extends Controller
{
    ...
    public function checkQuiz($QuizId)
    {
        ...
        return view("admin.quiz.checkquiz", ['quiz' => $quiz, 'studentsData' => $studentsData, 'quizCorrectAnswers' => $quizCorrectAnswers]);
    }
    ...
    public function checkQuizOptions($QuizId, Request $request)
    {
        ...
        return view("admin.quiz.checkquizoptions", ['quiz' => $quiz, 'student' => $student, 'StudentQuizId' => $StudentQuizId, 'answersMarkedByStudents' => $answersMarkedByStudents, 'quizQuestionsOptions' => $quizQuestionsOptions]);
    }
}
