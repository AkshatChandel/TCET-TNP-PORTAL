...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 25, 2022 at 01:35 PM
...
--
-- Table structure for table `placement_company`
--

CREATE TABLE `placement_company` (
  `Placement_Company_Id` bigint(20) NOT NULL,
  `Company_Name` varchar(100) NOT NULL,
  `Minimum_Class_10_Percentage` float NOT NULL,
  `Minimum_Class_12_Percentage` float NOT NULL,
  `Minimum_Diploma_Percentage` float NOT NULL,
  `Minimum_CGPA` float NOT NULL,
  `Placement_Company_Status` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `staff_designation` (
  ...
  `Designation_Id` bigint(20) NOT NULL,
  `Staff_Designation_Status` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indexes for table `placement_company`
--
ALTER TABLE `placement_company`
  ADD PRIMARY KEY (`Placement_Company_Id`);
...
--
-- AUTO_INCREMENT for table `placement_company`
--
ALTER TABLE `placement_company`
  MODIFY `Placement_Company_Id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `staff_designation`
  MODIFY `Staff_Designation_Id` bigint(20) NOT NULL AUTO_INCREMENT;
